...
void crea_correctamente(){
	...
	pa2m_afirmar(hash_cantidad(hash) == 0, "Hash creado con capacidad 0 devuelve hash creado con cantidad 0.");
	pa2m_afirmar(hash_capacidad(hash) == 3, "Hash creado con capacidad 0 devuelve hash creado con capacidad 3.");

	hash_destruir(hash);

	hash_t* hash2 = hash_crear(10000000);

	pa2m_afirmar(hash_cantidad(hash2) == 0, "Hash creado con capacidad 10000000 devuelve hash creado con cantidad 0.");
	pa2m_afirmar(hash_capacidad(hash2) == 10000000, "Hash creado con capacidad 10000000 devuelve hash creado con capacidad 10000000.");
...
void inserta_correctamente() {
	...
	pa2m_afirmar(hash_cantidad(hash) == 0, "Hash creado con capacidad 10 devuelve hash creado con cantidad 0.");
	pa2m_afirmar(hash_capacidad(hash) == 10, "Hash creado con capacidad 10 devuelve hash creado con capacidad 10.");

	hash_insertar(hash, "clave1", "valor1", NULL);
	pa2m_afirmar(hash_cantidad(hash) == 1, "Inserto valor1 en hash, devuelve hash con cantidad 1.");

	hash_insertar(hash, "clave2", "valor2", NULL);
	pa2m_afirmar(hash_cantidad(hash) == 2, "Inserto valor2 en hash, devuelve hash con cantidad 2.");

	hash_insertar(hash, "clave3", "valor3", NULL);
	pa2m_afirmar(hash_cantidad(hash) == 3, "Inserto valor3 en hash, devuelve hash con cantidad 3.");

	hash_insertar(hash, "clave4", "valor4", NULL);
	pa2m_afirmar(hash_cantidad(hash) == 4, "Inserto valor4 en hash, devuelve hash con cantidad 4.");

	hash_insertar(hash, "clave5", "valor5", NULL);
	pa2m_afirmar(hash_cantidad(hash) == 5, "Inserto valor5 en hash, devuelve hash con cantidad 5.");

	hash_insertar(hash, "clave6", "valor6", NULL);
	pa2m_afirmar(hash_cantidad(hash) == 6, "Inserto valor6 en hash, devuelve hash con cantidad 6.");

	hash_insertar(hash, "clave7", "valor7", NULL);
	pa2m_afirmar(hash_cantidad(hash) == 7, "Inserto valor7 en hash, devuelve hash con cantidad 7.");

	hash_insertar(hash, "clave8", "valor8", NULL);
	pa2m_afirmar(hash_cantidad(hash) == 8, "Inserto valor8 en hash, devuelve hash con cantidad 8.");

	hash_insertar(hash, "clave9", "valor9", NULL);
	pa2m_afirmar(hash_cantidad(hash) == 9, "Inserto valor9 en hash, devuelve hash con cantidad 9.");

	hash_insertar(hash, "clave10", "valor10", NULL);
	pa2m_afirmar(hash_cantidad(hash) == 10, "Inserto valor10 en hash, devuelve hash con cantidad 10.");
